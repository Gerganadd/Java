...
public class Main {
    ...
    public static void main(String[] args) throws CityNotKnownException, NoPathToDestinationException {
        ...
        City vidin = new City("Vidin", new Location(3000, 3000));
        ...
        List<Journey> schedule = List.of(
                ...
                new Journey(BUS, plovdiv, burgas, new BigDecimal("190")),
                new Journey(BUS, burgas, plovdiv, new BigDecimal("190")),
                ...
                new Journey(BUS, tarnovo, burgas, new BigDecimal("80")),
                new Journey(BUS, plovdiv, vidin, new BigDecimal("40")),
                new Journey(BUS, vidin, burgas, new BigDecimal("80"))
        );

        RideRight rideRight = new RideRight(schedule);
        rideRight.findCheapestPath(sofia, blagoevgrad, true)
                .stream()
                .forEach(x -> System.out.println(x.from().name() + "-" + x.to().name() + " price : " + x.price()));
